...
<div class="path">
  {tr}Current folder{/tr}: {if $parent_id>0}<a href="{$smarty.const.TIDBITS_PKG_URL}bookmarks.php">{tr}top{/tr}</a>&gt;{/if}{$path}</h2>
</div>
...
<table><tr><td width="50%" valign="top">
  <form action="{$smarty.const.TIDBITS_PKG_URL}bookmarks.php" method="post">
    <table class="panel">
      ...
      <tr class="panelsubmitrow">
          <td colspan="2"><input type="submit" class="btn btn-default" name="addfolder" value="{tr}add{/tr}" /> <a href="{$smarty.const.TIDBITS_PKG_URL}bookmarks.php?parent_id={$parent_id}&amp;editfolder=0">{tr}new{/tr}</a></td>
      </tr>
    </table>
  </form>
  ...
  <form action="{$smarty.const.TIDBITS_PKG_URL}bookmarks.php" method="post">
    <table class="panel">
      ...
      <tr class="panelsubmitrow">
          <td colspan="2"><input type="submit" class="btn btn-default" name="addurl" value="{tr}add{/tr}" /> <a href="{$smarty.const.TIDBITS_PKG_URL}bookmarks.php?parent_id={$parent_id}&amp;editurl=0">{tr}new{/tr}</a></td>
      </tr>
      </form>
    </table>
</td></tr></table>
