...
<form action="{$smarty.const.TIDBITS_PKG_URL}files.php" method="post">
<table class="panel">
<tr>
<th>&nbsp;</th>
<th><a href="{$smarty.const.TIDBITS_PKG_URL}files.php?offset={$offset}&amp;sort_mode={if $sort_mode eq 'filename_desc'}filename_asc{else}filename_desc{/if}">{tr}name{/tr}</a></th>
<th><a href="{$smarty.const.TIDBITS_PKG_URL}files.php?offset={$offset}&amp;sort_mode={if $sort_mode eq 'created_desc'}created_asc{else}created_desc{/if}">{tr}created{/tr}</a></th>
<th><a href="{$smarty.const.TIDBITS_PKG_URL}files.php?offset={$offset}&amp;sort_mode={if $sort_mode eq 'filesize_desc'}filesize_asc{else}filesize_desc{/if}">{tr}size{/tr}</a></th>
</tr>
...
{if $prev_offset >= 0}
[<a href="{$smarty.const.TIDBITS_PKG_URL}files.php?find={$find}&amp;offset={$prev_offset}&amp;sort_mode={$sort_mode}">{tr}prev{/tr}</a>]&nbsp;
{/if}
{tr}Page{/tr}: {$actual_page}/{$cant_pages}
{if $next_offset >= 0}
&nbsp;[<a href="{$smarty.const.TIDBITS_PKG_URL}files.php?find={$find}&amp;offset={$next_offset}&amp;sort_mode={$sort_mode}">{tr}next{/tr}</a>]
{/if}
...
<a href="{$smarty.const.TIDBITS_PKG_URL}files.php?find={$find}&amp;offset={$selector_offset}&amp;sort_mode={$sort_mode}">
...
<form enctype="multipart/form-data" action="{$smarty.const.TIDBITS_PKG_URL}files.php" method="post">
<table class="panel">
<!--
<tr>
